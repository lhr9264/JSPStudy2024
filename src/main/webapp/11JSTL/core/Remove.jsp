...
<body>
	...
	<ul>
		...
		<li>requestScope.scopeVar : ${ requesetScope.scopeVar }</li>
	...
	<!-- 
	영역을 지정한 상태에서 속성을 삭제한다. 이떄는 session에서만 삭제된다.
	 -->
	...
	<!-- 
	영역 지정없이 삭제하면 동일한 이름의 모듣ㄴ 속성이 한꺼번에 삭제된다.
	 -->
	<c:remove var="scopeVar" />
	<ul>
		<li>scopeVar : ${ scopeVar }</li>
		<li>requestScope.scopeVar : ${ requestScope.scopeVar }</li>
		<li>applicationScope.scopeVar : ${ applicationScope.scopleVar }</li>
	</ul>
</body>
</html>